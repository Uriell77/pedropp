...
def editar(id, datos):
    print(datos)
    cursor.execute("UPDATE usuarios SET (nombre, correo, password, log, status, saldo) = ('{0}','{1}','{2}','{3}','{4}','{5}') WHERE id = '{6}'".format(datos[1],datos[2],datos[3],datos[4],datos[5],datos[6], id))
    base.commit()
